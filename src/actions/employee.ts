 ...
 */
export const createEmployee = async (values: z.infer<typeof CreateEmployeeSchema>) => {
  try {
    // Get current session
 ...
 */
export const employeeLogin = async (values: z.infer<typeof EmployeeLoginSchema>) => {
  try {
    // Validate input
