...
const PurchaseDetailPage: NextPage<PurchaseDetailPageProps> = ({ purchase }) => {
          ...
          <CardContent>
            <div className="space-y-6">
                  ...
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800 dark:text-gray-300">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-3 text-right">Harga Beli</th>
                      ...
                      {purchase.items.map((item) => (
                        <tr key={item.id} className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                          ...
                          <td className="px-6 py-4 text-right font-medium">
                            Rp {(item.quantity * item.costAtPurchase).toLocaleString("id-ID")}
                          </td>
                        </tr>
                      ))}
                    </tbody>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-medium mb-3">Informasi Pembelian</h3>
