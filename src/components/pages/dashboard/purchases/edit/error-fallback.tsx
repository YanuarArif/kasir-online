...
const PurchaseEditErrorFallback: React.FC<ErrorFallbackProps> = ({
  purchaseId,
  errorMessage,
}) => {
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
          <div className="flex flex-col items-center justify-center py-12">
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Gagal memuat data yang diperlukan untuk mengedit pembelian.
            </p>
        ...
        <div className="lg:col-span-1 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
          <h3 className="text-lg font-medium mb-4">Ringkasan Pembelian</h3>
          <p className="text-gray-500 dark:text-gray-400">
            Informasi pembelian tidak tersedia saat ini.
          </p>
        </div>
      </div>
    </div>
...
export default PurchaseEditErrorFallback;
