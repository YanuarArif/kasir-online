...
import SaleFormTabs from "./components/SaleFormTabs";
import SaleTransactionSummary from "./components/SaleTransactionSummary";
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-4">
            <Button
              ...
              disabled={isPending}
            >
              <Link href="/dashboard/sales">Batal</Link>
            </Button>
